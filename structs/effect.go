...
var (
	...
	ActivityStreak1  = &Effect{"Activity Streak 1", "User", "+", 1}
	ActivityStreak2  = &Effect{"Activity Streak 2", "User", "+", 2}
	ActivityStreak3  = &Effect{"Activity Streak 3", "User", "+", 3}
	...
	Effects = map[string]*Effect{
		...
		"Activity Streak 1": ActivityStreak1,
		"Activity Streak 2": ActivityStreak2,
		"Activity Streak 3": ActivityStreak3,
	}
)
